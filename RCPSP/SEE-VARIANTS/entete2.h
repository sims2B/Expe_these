...
char NomFichier[175], FichierVerif[175], NomFichierT[175];
...
void define_data(IloEnv env) {
   ...
   int i,j,k;
//   strncpy_s(NomFichier, NFichier.c_str(), 100 );
   strcpy(NomFichier,NFichier.c_str());
...
//        strncpy_s( NomFichierT, NFichierT.c_str(), 75 );
        strcpy( NomFichierT, NFichierT.c_str());
...
//   strncpy_s(SolFile, NFichierTemp.c_str(), 100 );
   strcpy(SolFile, NFichierTemp.c_str());
