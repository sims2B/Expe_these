...
int main( int argc, char* argv[]){
  ...
  while (!res_file.eof()){
	...
	res_file.ignore(1000, ':');
	res_file >> res_line.nb_MIP;
	res_file.ignore(1000, ':');
	res_file >> res_line.nb_checkER;
	res_file.ignore(1000, ':');
	res_file >> res_line.nb_adjust;
      }
      else {
	res_line.feas=0;
	res_line.solved=0;
  ...
  for (int j=0;j<5;++j){
    ...
    if (res_line.feas) {
      res_line.tree_time=res_line.tree_time/res_line.feas;
      res_line.MIP_time=res_line.MIP_time/res_line.feas;
      res_line.nb_node=res_line.nb_node/res_line.feas;
      res_line.nb_MIP+=res_line.nb_MIP/res_line.feas;
      res_line.nb_adjust=res_line.nb_adjust/res_line.feas;
      res_line.nb_checkER=res_line.nb_checkER/res_line.feas;
    }
